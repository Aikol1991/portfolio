...
import Image from '../assets/john11.jpg';
import { FaYoutube, FaDribbble} from 'react-icons/fa';
            ...
            <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
                <div className="flex-1 text-center font-secondary lg:text-left">
                    ...
                    <motion.p variants={fadeIn('up', 0.5)}
                        ...
                        Adipisci aliquam aliquid,
                        animi doloremque ducimus.
                    </motion.p>
                    <div className="flex max-w-max gap-x-6 items-center mb-8 mx-auto lg:mx-0">
                    ...
                    <motion.div variants={fadeIn('up', 0.7)}
                                initial="hidden" whileInView={'show'}
                                viewport={{once: false, amount: 0.7}}
                                className="flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-10">
                        <a href="#">
                            <FaYoutube/>
                        </a>
                        <a href="#">
