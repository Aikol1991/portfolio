        ...
        <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row">
                <motion.div
                    ...
                    <div>
                        <h4 className="text-xl uppercase text-secondary font-medium mb-2 tracking-wide">Get in touch</h4>
                        <h2 className='text-[45px] lg:text-[90px] mb-12 leading-none'>Let me be<br/> Your Killer! </h2>
                    </div>
                </motion.div>
                <motion.form
